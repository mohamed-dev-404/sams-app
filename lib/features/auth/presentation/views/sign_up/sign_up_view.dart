...
import 'package:sams_app/features/auth/presentation/views/sign_up/widgets/shared/register_success_dialog.dart';
        ...
        if (state.status == SignUpStatus.failure) {
          ...
          showRegisterSuccessDialog(
            ...
            onButtonPressed: () {
              ...
              context.pop();
              // 2. Then navigate to the activateAccount screen
