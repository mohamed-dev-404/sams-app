...
class ActivateAccountMobileLayout extends StatefulWidget {
  const ActivateAccountMobileLayout({super.key});

  @override
  State<ActivateAccountMobileLayout> createState() =>
      _ActivateAccountMobileLayoutState();
}

class _ActivateAccountMobileLayoutState
    extends State<ActivateAccountMobileLayout> {
