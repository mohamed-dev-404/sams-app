...
class VerifyOtpWebLayout extends StatefulWidget {
  const VerifyOtpWebLayout({super.key});

  @override
  State<VerifyOtpWebLayout> createState() => _VerifyOtpWebLayoutState();
}

class _VerifyOtpWebLayoutState extends State<VerifyOtpWebLayout> {
