...
class AddAnnouncementMobileViewBody extends StatefulWidget {
  const AddAnnouncementMobileViewBody({super.key});

  @override
  State<AddAnnouncementMobileViewBody> createState() => _AddAnnouncementMobileViewBodyState();
}

class _AddAnnouncementMobileViewBodyState extends State<AddAnnouncementMobileViewBody> {
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            AddAnnouncementSection(titleController: _titleController, contentController: _contentController),
