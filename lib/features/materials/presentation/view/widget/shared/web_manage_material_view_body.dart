...
import 'package:sams_app/features/materials/presentation/view/widget/shared/course_material_section.dart';

class WebManageMaterialViewBody extends StatelessWidget {
  const WebManageMaterialViewBody({super.key, required this.isEditing});
                ...
                IntrinsicHeight(
                  child: Row(
                    ...
                    children: [
                      ...
                      const Expanded(
                        child:
                            CourseMaterialSection(), // دلوقتي هتاخد نفس طول اللي جنبها
                      ),
                    ],
                  ),
                ),
