...
class AppStyles {
  ...
  // =========================================================
  // 🟣 MOBILE — TITLES (More Controlled Clamping)
  // =========================================================
  ...
  // =========================================================
  // 🟡 MOBILE — BODY TEXT (Consistency is Key)
  // =========================================================
  ...
  static TextStyle get mobile17Semibold => TextStyle(
    fontSize: 17.07.sp.clamp(15, 19),
    fontWeight: FontWeight.w600,
    fontFamily: _fontFamily,
  );

  // =========================================================
  // 🌍 WEB — TITLES (Refined for High-Res Screens)
  // =========================================================
  ...
  // =========================================================
  // 🌍 WEB — SPECIAL CASES (Precise Ranges)
  // =========================================================

  static TextStyle get web30Semibold => TextStyle(
    fontSize: 30.sp.clamp(26, 34),
    fontWeight: FontWeight.w600,
    fontFamily: _fontFamily,
  );
